...
- Consumption (tax)
  -  A variable used in the consumption tax data which represents the percent of revenue that consumption tax generates for a country within a given year. The variable represents the tax side of the project. This variable is also observed in the final data and is used to generate figures seen in the output section. A popular consumption tax referenced in the paper is VAT (Value Added Tax). [(Section #5)](#Data-Outputs)
- International (Tax)
  - A variable used in the international data describes the percentage of revenue generated by international tax for a given country within a given year. It represents the tariffs side of the project. The variable is also observed in the final data and is used to generate figures seen in the output section. [(Section #5)](#Data-Outputs)
- GDP (Per Capita)
